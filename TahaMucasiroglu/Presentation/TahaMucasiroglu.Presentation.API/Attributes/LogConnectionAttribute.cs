...
namespace TahaMucasiroglu.Presentation.API.Attributes
{
    public class LogConnectionAttribute : ActionFilterAttribute // istenilen yerde istekleri basar
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            //TODO: burada alınabilecek bilgileri al sonra hatalı durumlarda error logu kalanlarında info vs ayarla.
        }
    }
}
