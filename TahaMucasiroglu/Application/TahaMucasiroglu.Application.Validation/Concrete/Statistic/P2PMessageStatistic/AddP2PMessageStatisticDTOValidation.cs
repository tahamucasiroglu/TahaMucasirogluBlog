...
{
    public class AddP2PMessageStatisticListDTOValidation : AbstractValidator<IEnumerable<AddP2PMessageStatisticDTO>>
    {
        public AddP2PMessageStatisticListDTOValidation()
        {
            RuleForEach(x => x).SetValidator(new AddP2PMessageStatisticDTOValidation());
        }
    }
    public class AddP2PMessageStatisticDTOValidation : StatisticAddValidation<AddP2PMessageStatisticDTO>
    {
        public AddP2PMessageStatisticDTOValidation() : base()
        {
            // Zorunlu alanlar
