...
{
    public class UpdateP2PMessageStatisticListDTOValidation : AbstractValidator<IEnumerable<UpdateP2PMessageStatisticDTO>>
    {
        public UpdateP2PMessageStatisticListDTOValidation()
        {
            RuleForEach(x => x).SetValidator(new UpdateP2PMessageStatisticDTOValidation());
        }
    }
    public class UpdateP2PMessageStatisticDTOValidation : StatisticUpdateValidation<UpdateP2PMessageStatisticDTO>
    {
        public UpdateP2PMessageStatisticDTOValidation() : base()
        {
            // Zorunlu alanlar
