...
{
    public class UpdateCvStatisticListDTOValidation : AbstractValidator<IEnumerable<UpdateCvStatisticDTO>>
    {
        public UpdateCvStatisticListDTOValidation()
        {
            RuleForEach(x => x).SetValidator(new UpdateCvStatisticDTOValidation());
        }
    }
    public class UpdateCvStatisticDTOValidation : StatisticUpdateValidation<UpdateCvStatisticDTO>
    {
        public UpdateCvStatisticDTOValidation() : base()
        {
            // Zorunlu alanlar
