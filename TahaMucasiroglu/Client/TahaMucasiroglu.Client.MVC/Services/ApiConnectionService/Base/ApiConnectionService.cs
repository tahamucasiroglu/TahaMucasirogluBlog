...
using System.Text;
using TahaMucasiroglu.Client.MVC.Managers.UrlManager;
using TahaMucasiroglu.Client.MVC.Services.ApiConnectionService.Abstract;
...
namespace TahaMucasiroglu.Client.MVC.Services.ApiConnectionService.Base
{
